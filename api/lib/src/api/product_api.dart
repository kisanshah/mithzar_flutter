...
class ProductApi {
  ...
  Future<Response<ProductVariant>> getVariantById({
    ...
    final _path =
        r'/product/variant/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<ProductVariant, ProductVariant>(
  ...
  Future<Response<List<ProductVariant>>> getVariants({
    ...
    List<ProductVariant>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<ProductVariant>, ProductVariant>(
    ...
    return Response<List<ProductVariant>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
