...
class AddressApi {
  ...
  Future<Response<BuiltList<Address>>> addressAllGet({ 
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Success>> addressDefaultIdPatch({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Address>> addressSavePost({ 
    Address? address,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Address] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Address>> addressUpdatePut({ 
    Address? address,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
